...
wgpu::Device MyWGPUPassImp::createDeviceByNativeAPI(wgpu::BackendType backendType) {
    ...
    utils::SetOpenGLGetProcFromInside();
    ...
    utils::WGPUSetLogCallback(cDevice);
...
wgpu::Device MyWGPUPassImp::createDeviceByCppAPI() {
    ...
    utils::WGPUSetLogCallback(device.Get());
    return device;
}
...
//        })");
    ...
    descriptor1.vertex.module = vs2Module;
    ...
    fragmentState.module = fs2Module;
